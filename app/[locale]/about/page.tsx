...
// import CustomButton from "@/components/CustomButton" // Remove this line
      ...
      <section className="h-screen bg-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              About
              <span className="block text-[#00A651] italic font-light">GWI</span>
            </motion.h1>
            <motion.p
            ...
            >
              Global Wise Investments is a venture capital firm focused on investment opportunities in AI applications,
              mobile products, and gaming.
            </motion.p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <div>
                ...
                <p className="font-playfair text-xl md:text-2xl text-gray-300 leading-relaxed font-light italic tracking-wide mb-6">
                  Our mission is to create positive economic impact and long-term value for all stakeholders — including
                  our investors, portfolio companies, and the broader community.
                </p>
                <p className="font-playfair text-lg text-gray-400 leading-relaxed font-light tracking-wide">
                  We bring deep expertise and broad networks in the mobile internet industry.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-playfair text-xl md:text-2xl text-gray-300 leading-relaxed font-light italic tracking-wide">
                  We invest in promising early-stage companies — from seed to pre-Series A — that are building
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="font-playfair text-2xl text-gray-400 max-w-5xl mx-auto font-light italic tracking-wide">
              We specialize in three key areas that are transforming the digital landscape and creating new
            ...
            {[
              {
                ...
                description:
                  "Supporting artificial intelligence solutions that enhance productivity, automate processes, and create new possibilities across industries.",
              },
              {
                icon: Smartphone,
                title: "Mobile Products",
                description:
                  "Investing in innovative mobile applications and platforms that connect users and transform digital experiences.",
              },
              {
                icon: Gamepad2,
                title: "Gaming",
                description:
                  "Backing next-generation gaming experiences and interactive entertainment that push creative boundaries.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="h-screen bg-gradient-to-t from-black via-gray-900 to-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <motion.div
            ...
            className="mb-20"
          >
            <h2 className="font-playfair text-6xl md:text-8xl font-light text-white mb-8 tracking-wide">GWI Foundry</h2>
            <p className="font-playfair text-2xl text-gray-300 max-w-5xl mx-auto font-light italic tracking-wide mb-12">
              We also collaborate with top-tier marketing partners to run a specialized founder-first incubator that
              supports product/tech-driven startups with capital, resources, and go-to-market expertise.
            </p>
            <p className="font-playfair text-xl text-gray-400 max-w-4xl mx-auto font-light tracking-wide">
              GWI Foundry is our incubation program designed for product-focused founders. We offer early capital,
              strategic guidance, and growth support in partnership with top marketing firms.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <CustomButton href="/incubator" variant="solid" className="text-2xl py-6">
              Learn More About GWI Foundry
            </CustomButton>
          </motion.div>
        </div>
      </section>
