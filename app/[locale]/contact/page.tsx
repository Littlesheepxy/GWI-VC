      ...
      <section className="h-screen bg-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              Let's Build the
              <span className="block text-[#00A651] italic font-light">Future</span>
            ...
            >
              Whether you're a founder with a bold vision or an investor looking to partner with us, we'd love to hear
              from you.
            </motion.p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            >
              ...
              <div className="space-y-8">
                <h3 className="font-playfair text-3xl font-light text-white tracking-wide">Get in touch</h3>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <h4 className="font-playfair text-xl font-light text-white mb-2 tracking-wide">Email</h4>
                      <p className="font-inter text-gray-400 font-light tracking-wide text-lg">
      ...
      <section className="h-screen bg-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              Ready to Partner
              <span className="block text-[#00A651] italic font-light">with Us?</span>
            </motion.h2>
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Join our portfolio of exceptional companies and gain access to our global network, strategic expertise,
